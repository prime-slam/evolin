...
class RelativePoseEstimator:
    def __init__(self):
        self.iterations_number = 20
        self.optimizer_iterations_number = 10
        self.reprojection_threshold = 1000
        self.edges_min_number = 10
    ...
    def estimate(
        ...
        inlier_mask = np.ones((2 * lines_number,), dtype=bool)
