...
@pytest.mark.parametrize(
    ...
    [
        (np.array([[[1, 0], [1, 0]]]), np.array([[[1, 0], [1, 0]]]), np.array([[0]]), np.array([[0]])),
        (np.array([[[1, 0], [0, 1]]]), np.array([[[0, 1], [1, 0]]]), np.array([[0]]), np.array([[0]])),
        (
            np.array([[[1, 0], [0, 1]]]),
            np.array([[[5, 1], [1, 0]], [[0, 1], [1, 0]]]),
            np.array([[5, 0]]), np.array([[19, 0]])
        ),
    ],
)
def test_correct_structural_distance(
    ...
    actual_distance_squared = StructuralDistance().calculate(first_lines, second_lines, squared=True)
